...
impl SimulationClient {
    ...
    pub async fn get_execution_environment(&self, a: simulation_args::GetExecutionEnvironment) -> Result<simulation_args::ExecutionEnvironment> {
        let url = self.base_url.join("/get-execution-environment").context(Parse)?;
    ...
    pub async fn get_execution_environment_state(&self, a: simulation_args::GetExecutionEnvironmentState) -> Result<[u8; 32]> {
        let url = self.base_url.join("/get-execution-environment-state").context(Parse)?;
    ...
    pub async fn get_shard_state(&self, a: simulation_args::GetShardState) -> Result<simulation_args::ShardState> {
