...
impl Handle {
    pub async fn create_shard_chain(&self, arg: args::CreateShardChain) -> Result<u32> {
    ...
    pub async fn create_shard_block(&self, arg: args::CreateShardBlock) -> Result<u32> {
        let (sender, receiver) = channel(1);
    ...
    pub async fn shard_block(&self, arg: args::GetShardBlock) -> Result<ShardBlock> {
        let (sender, receiver) = channel(1);
